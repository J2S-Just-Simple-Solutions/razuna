					...
					<td id="selectme">
						...
						<cfloop query="qry_files">
							...
							<div class="assetbox" style="<cfif cs.assetbox_width NEQ "">width:#cs.assetbox_width#px;</cfif><cfif cs.assetbox_height NEQ "">min-height:#cs.assetbox_height#px;</cfif>">
								<cfif is_available>
									...
									<cfloop list="#attributes.cs_place.top.video#" index="m" delimiters=",">
										...
										<cfif m CONTAINS "_filename">
											<a href="##" onclick="showwindow('#myself##xfa.assetdetail#&file_id=#vid_id#&what=videos&loaddiv=#kind#&folder_id=#folder_id#&showsubfolders=#attributes.showsubfolders#&row=#mycurrentRow#&filecount=#qry_filecount.thetotal#','#Jsstringformat(vid_filename)#',1070,1);return false;"><strong>#evaluate(listlast(m," "))#</strong></a>
									...
									<br/><br/>
									<a href="##" onclick="showwindow('#myself##xfa.assetdetail#&file_id=#vid_id#&what=videos&loaddiv=#kind#&folder_id=#folder_id#&showsubfolders=#attributes.showsubfolders#&row=#mycurrentRow#&filecount=#qry_filecount.thetotal#','#Jsstringformat(vid_filename)#',1070,1);return false;">
									...
									<cfif attributes.cs.videos_metadata EQ "">
										<a href="##" onclick="showwindow('#myself##xfa.assetdetail#&file_id=#vid_id#&what=videos&loaddiv=#kind#&folder_id=#folder_id#&showsubfolders=#attributes.showsubfolders#&row=#mycurrentRow#&filecount=#qry_filecount.thetotal#','#Jsstringformat(vid_filename)#',1070,1);return false;"><strong>#left(vid_filename,50)#</strong></a>
									<cfelse>
										<br />
								...
								<cfelse>
									"#vid_filename#" en cours de traitement !
									<br /><br>
				...
				<cfloop query="qry_files">
					...
					<tr class="list thumbview">
						...
						<td width="100%" valign="top">
							<a href="##" onclick="showwindow('#myself##xfa.assetdetail#&file_id=#vid_id#&what=videos&loaddiv=#kind#&folder_id=#folder_id#&showsubfolders=#attributes.showsubfolders#&row=#mycurrentRow#&filecount=#qry_filecount.thetotal#','#Jsstringformat(vid_filename)#',1070,1);return false;"><strong>#vid_filename#</strong></a>
							<br />
							<!--- Icons --->
