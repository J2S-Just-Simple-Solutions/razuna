				...
				<td width="90">
					...
					<cfelse>
						<cfif fav_kind EQ "img">
							<a href="##" onclick="showwindow('#myself##xfa.imagedetail#&file_id=#myid#&what=images&loaddiv=&folder_id=#qry_favorites.folder_id#','#thename#',1070,1);return false;">
						...
						<cfelseif fav_kind EQ "vid">
							<a href="##" onclick="showwindow('#myself##xfa.videodetail#&file_id=#myid#&what=videos&loaddiv=&folder_id=#qry_favorites.folder_id#','#thename#',1070,1);return false;">
						...
						<cfelseif fav_kind EQ "aud">
							<a href="##" onclick="showwindow('#myself##xfa.audiodetail#&file_id=#myid#&what=audios&loaddiv=&folder_id=#qry_favorites.folder_id#','#thename#',1070,1);return false;">
						...
						<cfelse>
							<a href="##" onclick="showwindow('#myself##xfa.filedetail#&file_id=#myid#&what=files&loaddiv=&folder_id=#qry_favorites.folder_id#','#thename#',1070,1);return false;">
