...
function searchadv_files(theform, thefa, folderid) {
	...
	if (illegalChars.test(p1)){
		...
		// }
		// Fire search
		$('#loading_searchadv').html('<div style="position: fixed; top: 0; bottom: 0; left: 0; right: 0; "><div style="border-radius: 10px;     box-shadow: 0px 1px 3px rgba(000,000,000,0.5),  inset 0px 0px 3px rgba(255,255,255,1);     -webkit-border-radius: 10px;     -moz-border-radius: 10px;     -moz-box-shadow: 0px 1px 3px rgba(000,000,000,0.5),  inset 0px 0px 3px rgba(255,255,255,1);     -webkit-box-shadow: 0px 1px 3px rgba(000,000,000,0.5),  inset 0px 0px 3px rgba(255,255,255,1);     width: 160px;     height: 35px;     text-align: center;     line-height: 50px;     background-color: #82cdff;     color: white;     position: absolute;     left: 50%;     top: 50%;     margin-left: -50px;     margin-top: -50px;     z-index: 9999;"><img src="' + dynpath + '/global/host/dam/images/loading-bars.gif" border="0" style="padding:10px;"></div></div>');
