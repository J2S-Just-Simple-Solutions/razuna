...
<!---J2S<cfif not IsDefined("qry_img.cnt")><cfset QueryAddcolumn(qry_img, "cnt", "integer", amount)></cfif>--->	
...
<!---J2S<cfif not IsDefined("qry_vid.cnt")><cfset QueryAddcolumn(qry_vid, "cnt", "integer", amount)></cfif>--->
...
<!---J2S<cfif not IsDefined("qry_aud.cnt")><cfset QueryAddcolumn(qry_aud, "cnt", "integer", amount)></cfif>--->
...
<!---J2S<cfif not IsDefined("qry_doc.cnt")><cfset QueryAddcolumn(qry_doc, "cnt", "integer", amount)></cfif>--->
