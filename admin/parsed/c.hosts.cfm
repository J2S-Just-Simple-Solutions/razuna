...
<cfset myFusebox.thisFuseaction = "hosts">
...
<cftry>
<cfoutput><cfinclude template="../views/ajaxparts/dsp_hosts_main.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 18 and right(cfcatch.MissingFileName,18) is "dsp_hosts_main.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_hosts_main.cfm in circuit ajax which does not exist (from fuseaction ajax.hosts).">
