...
<!--- circuit: c --->
<!--- fuseaction: folder_subscribe_task --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "c">
<cfset myFusebox.thisFuseaction = "folder_subscribe_task">
...
<cfset thetask = myFusebox.getApplicationData().scheduler.folder_subscribe_task() >
