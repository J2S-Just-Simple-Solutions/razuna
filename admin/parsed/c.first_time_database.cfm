...
<!--- circuit: c --->
<!--- fuseaction: first_time_database --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "c">
<cfset myFusebox.thisFuseaction = "first_time_database">
...
<cfset session.firsttime.type = "custom" />
<!--- do action="ajax.first_time_database" --->
<cfset myFusebox.thisCircuit = "ajax">
<cftry>
<cfoutput><cfinclude template="../views/ajaxparts/dsp_firsttime_database.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 26 and right(cfcatch.MissingFileName,26) is "dsp_firsttime_database.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_firsttime_database.cfm in circuit ajax which does not exist (from fuseaction ajax.first_time_database).">
