...
<!--- circuit: c --->
<!--- fuseaction: prefs_global_storage --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "c">
<cfset myFusebox.thisFuseaction = "prefs_global_storage">
...
<cftry>
<cfoutput><cfinclude template="../views/ajaxparts/dsp_pref_global_storage.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 27 and right(cfcatch.MissingFileName,27) is "dsp_pref_global_storage.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_pref_global_storage.cfm in circuit ajax which does not exist (from fuseaction ajax.prefs_global_storage).">
