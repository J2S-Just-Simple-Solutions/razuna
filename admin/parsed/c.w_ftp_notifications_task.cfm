...
<!--- circuit: c --->
<!--- fuseaction: w_ftp_notifications_task --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "c">
<cfset myFusebox.thisFuseaction = "w_ftp_notifications_task">
...
<cfset myFusebox.getApplicationData().scheduler.ftp_notifications_task() >
