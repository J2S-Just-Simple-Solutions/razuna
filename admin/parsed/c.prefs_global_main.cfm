...
<!--- circuit: c --->
<!--- fuseaction: prefs_global_main --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "c">
<cfset myFusebox.thisFuseaction = "prefs_global_main">
...
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 24 and right(cfcatch.MissingFileName,24) is "dsp_pref_global_main.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_pref_global_main.cfm in circuit ajax which does not exist (from fuseaction ajax.prefs_global_main).">
