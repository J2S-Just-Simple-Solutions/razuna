...
<!--- circuit: c --->
<!--- fuseaction: hosts_checkhostname --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "c">
<cfset myFusebox.thisFuseaction = "hosts_checkhostname">
...
<cfset qry_check = myFusebox.getApplicationData().hosts.checkname(attributes) >
<!--- do action="ajax.hosts_checkhostname" --->
<cfset myFusebox.thisCircuit = "ajax">
<cftry>
<cfoutput><cfinclude template="../views/ajaxparts/dsp_hosts_check.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "dsp_hosts_check.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_hosts_check.cfm in circuit ajax which does not exist (from fuseaction ajax.hosts_checkhostname).">
