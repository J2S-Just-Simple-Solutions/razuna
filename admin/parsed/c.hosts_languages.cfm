...
<!--- circuit: c --->
<!--- fuseaction: hosts_languages --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "c">
<cfset myFusebox.thisFuseaction = "hosts_languages">
...
<cfset attributes.thepath = "#pathoneup#/global/" />
...
<cftry>
<cfoutput><cfinclude template="../views/ajaxparts/dsp_hosts_languages.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 23 and right(cfcatch.MissingFileName,23) is "dsp_hosts_languages.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_hosts_languages.cfm in circuit ajax which does not exist (from fuseaction ajax.hosts_languages).">
