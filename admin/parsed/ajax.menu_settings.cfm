...
<!--- circuit: ajax --->
<!--- fuseaction: menu_settings --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "ajax">
<cfset myFusebox.thisFuseaction = "menu_settings">
...
<cftry>
<cfoutput><cfinclude template="../views/ajaxparts/dsp_menu_settings.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 21 and right(cfcatch.MissingFileName,21) is "dsp_menu_settings.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_menu_settings.cfm in circuit ajax which does not exist (from fuseaction ajax.menu_settings).">
