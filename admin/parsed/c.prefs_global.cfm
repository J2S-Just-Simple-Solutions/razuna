...
<!--- circuit: c --->
<!--- fuseaction: prefs_global --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "c">
<cfset myFusebox.thisFuseaction = "prefs_global">
...
<cfset qry_allsettings = myFusebox.getApplicationData().Settings.allsettings() >
<cfset prefs = myFusebox.getApplicationData().Settings.prefs_global() >
<cfset qry_langs = myFusebox.getApplicationData().Settings.lang_get() >
<!--- do action="ajax.prefs_global" --->
<cfset myFusebox.thisCircuit = "ajax">
<cftry>
<cfoutput><cfinclude template="../views/ajaxparts/dsp_pref_global.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "dsp_pref_global.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_pref_global.cfm in circuit ajax which does not exist (from fuseaction ajax.prefs_global).">
