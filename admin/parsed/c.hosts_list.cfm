...
<!--- circuit: c --->
<!--- fuseaction: hosts_list --->
<cftry>
<cfset myFusebox.thisPhase = "appinit">
<cfset myFusebox.thisCircuit = "c">
<cfset myFusebox.thisFuseaction = "hosts_list">
...
<cfif not isDefined("attributes.offset")><cfset attributes.offset = "0" /></cfif>
<cfset session.offset = "#attributes.offset#" />
<cfset qry_hostslist = myFusebox.getApplicationData().hosts.getall() >
<!--- do action="ajax.hosts_list" --->
<cfset myFusebox.thisCircuit = "ajax">
<cftry>
<cfoutput><cfinclude template="../views/ajaxparts/dsp_hosts_list.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 18 and right(cfcatch.MissingFileName,18) is "dsp_hosts_list.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_hosts_list.cfm in circuit ajax which does not exist (from fuseaction ajax.hosts_list).">
